...
class SignInViewModel(
    ...
    // 저장된 토큰이 없는 경우 authTokenProvider.token 이 null 을 반환합니다.
    // 따라서 optionalOf() 함수를 사용하여 SupportOptional 로 이를 감싸줍니다.
